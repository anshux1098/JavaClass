...
|---|---|---|---|---|
| `casestudy1.java` | `CaseStudy/` | Case Study 1 — Student Result Management System | Scanner, arrays, grading logic | ✅ Done |
| `casestudy2.java` | `CaseStudy/` | Case Study 2: Bank Account | Scanner, arrays, grading logic | ✅ Done |
| `casestudy3.java` | `CaseStudy/` | Case Study 3: Employee Salary Management | Scanner, arrays, grading logic | ✅ Done |
| `casestudy4.java` | `CaseStudy/` | Case Study 4: Online Shopping Cart | Scanner, arrays, grading logic | ✅ Done |
